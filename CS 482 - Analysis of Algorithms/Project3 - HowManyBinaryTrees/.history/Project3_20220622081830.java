...
public class Project3 {
    ...
    //this function should only create a tree with head as the root and all possible organizations of the number head-1 and a
    public static BST createTree(int head) {

...
if (N % 2 == 0) {
    int m = N - 1, k = N - 1 - m; 
    for (int i = 0; i < (N/2); i++) {
        current_count.add(BigInteger.valueOf(amt_of_trees.get(m)) * BigInteger.valueOf(amt_of_trees.get(k)));
    }
}

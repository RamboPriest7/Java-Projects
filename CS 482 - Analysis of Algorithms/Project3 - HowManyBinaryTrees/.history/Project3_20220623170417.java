...
//amt of rotations for N = N-1
//sub tree rotation when N is root should equal amt_of_trees.get(N-2)
// if ()
    ...
    for (int i = 1; i < N ;i++) {
       // BST datree = new BST(i);
        amt_of_trees.add(     amt_of_trees.get(i-1).add(amt_of_trees.get(i-1))       );
    }

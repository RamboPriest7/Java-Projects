...
public class Project3 {
    ...
    static class BST {
        ...
        @Override
        public BST `clone()` throws CloneNotSupportedException {
            BST b = (BST) super.clone();

            b.left = (BST) this.left.super.clone();
            b.right = new BST(this.right)

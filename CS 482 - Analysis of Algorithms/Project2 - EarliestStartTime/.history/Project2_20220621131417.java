    ...
    public static boolean overlap() {
        for (int i = 0; i < intervals.size(); i++) {
            for (int j = 0; j < intervals.size(); j++) {
                if (i != j && (intervals.get(i)[0] < intervals.get(j)[0] && intervals.get(i)[1] > intervals.get(j)[0] || intervals.get(i)[0] < intervals.get(j)[0] && intervals.get(i)[1] > intervals.get(j)[1])) {

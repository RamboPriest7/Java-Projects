...
public class Project2 {
    ...
    public static boolean overlap() {
        for (int i = 0; i < intervals.size(); i++) {
            for (int j = 0; j < intervals.size(); j++) {
                if (i != j && ((intervals.get(i)[0] < intervals.get(j)[0] && intervals.get(i)[1] > intervals.get(j)[0]) || (intervals.get(i)[0] < intervals.get(j)[1] && intervals.get(i)[1] > intervals.get(j)[1]))) {
    ...
    public static int findEarliest() {
        ...
        if (already_checked_earliest.get(index)) {index = -1;}
      if (index != -1) { already_checked_earliest.set(index, true) ;}
...
System.out.println(earliest);
        for (int i = 0; i < intervals.size(); i++) {
            if (i != earliest) {
                ...
                if ((intervals.get(earliest)[0] < intervals.get(i)[0] && intervals.get(earliest)[1] > intervals.get(i)[0] ) || intervals.get(earliest)[0] < intervals.get(i)[1] && intervals.get(earliest)[1] > intervals.get(i)[1]  ) {
                   //intervals.get(earliest)[0] < intervals.get(i)[0] && intervals.get(earliest)[1] > intervals.get(i)[0]  
...
//if (intervals.get(earliest)[0] < intervals.get(i)[0] && intervals.get(earliest)[1] > intervals.get(i)[0])
//if (intervals.get(earliest)[0] < intervals.get(i)[1] && intervals.get(earliest)[1] > intervals.get(i)[1])

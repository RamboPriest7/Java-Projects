...
public class Project2 {
    ...
    public static int findEarliest() {
        ...
        for (int i = 0; i < intervals.size(); i++) {
            ...
            if (intervals.get(i)[0] == min && i already_checked_earliest.contains(i)) {
...
//we must have a function that only finds overlaps for 1 interval and do that and THEN call findEarliest again
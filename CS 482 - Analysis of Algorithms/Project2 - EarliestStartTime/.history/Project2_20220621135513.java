...
// for some reason the findCard function is terminating even tho the function
// still returns true

// the overlap functions call findEarliest twice, resetting the return value and
// doesnt remove 4, 5
// we must have a function that only finds overlaps for 1 interval and do that
// and THEN call findEarliest again
...
System.out.println(earliest);
        for (int i = 0; i < intervals.size(); i++) {
            if (i != earliest) {
                ...
                if ((intervals.get(earliest)[0] < intervals.get(i)[0] && intervals.get(earliest)[1] > intervals.get(i)[0] ) || intervals.get(earliest)[0] < intervals.get(i)[0] && intervals.get(earliest)[1] > intervals.get(i)[1]  ) {

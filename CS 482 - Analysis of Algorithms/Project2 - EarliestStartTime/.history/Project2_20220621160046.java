...
public class Project2 {
    ...
    public static int findEarliest() {
        ...
        for (int i = 0; i < intervals.size(); i++) {
            ...
            if (intervals.get(i)[0] == min && !already_checked_earliest.contains(intervals.get(i))) {

                duplicate_earliest = true;

            } else if (intervals.get(i)[0] < min && !already_checked_earliest.contains(intervals.get(i))) {
        ...
        if (duplicate_earliest) {
            int start_duplicate = min;
            for (int i = 0; i < N; i++) {
                if (intervals.get(i)[1] < min_finish && intervals.get(i)[0] == start_duplicate) {
    ...
    public static void removeConflicts() {
        ...
        while (overlap()) {
            ...
            for (int i = 0; i < intervals.size(); i++) {
                ...
                if (i != earliest && i < intervals.size()) {

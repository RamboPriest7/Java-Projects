...
public class BST<E> implements Tree<E> {
  ...
  /* function printLevel does its namesake */
  void printLevel(TreeNode<E> n, int l) {
    if (n == null)
      return;
    if (l == 1)
  ...
  public void nonRecursiveInorder() {
    ...
    while (curr != null || !nodeStack.isEmpty()) {
      ...
      curr = nodeStack.pop(); //get rid of left (null), curr = previous data 
  ...
  public void nonRecursivePostorder() {
    // Left as exercise
    TreeNode<E> r = root, e = null;
    if (r == null)
      return;
    Stack<TreeNode<E>> nodeStack = new Stack<TreeNode<E>>();
    while (r != null || !nodeStack.isEmpty()) {
      if (r != null) {
        nodeStack.push(r);
        r = r.left;
      } // if ends
        ...
        r = nodeStack.peek();
        if (r.right == null || r.right == e) {//r = s5,r.right = s4, e = s2, TOS = s1
  ...
  public void nonRecursivePreorder() {
    ...
    curr = (!nodeStack.isEmpty()) ? nodeStack.pop() : curr;
    } // while ends
  }
